...
// let zajak = new Rabbit("polar","white") //kreirame instanca od funkcijata Rabbit so svojstva koi nie gi zadavame
// console.log(zajak)
...
// ovoj nacin so definiranje na prototip funkcii ne se koristi cesto!
...
// let sanja = new Ucenik("Sanja", "Taskovska", 29, 40) //so new se kreira nov objekt
// console.log(sanja)
// sanja.pecatiPoeni()

// let dance = new Ucenik("Dance", "Baceva", 20, 80)
// dance.pecatiPoeni()
